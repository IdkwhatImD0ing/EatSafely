          ...
          <div className="grid-cols-2">
            <div className="grid-item-2">
              ...
              <p className="info-text">
                ...
                Salmonella, and Clostridium perfringens. The CDC also estimates
                that the economic cost of foodborne illness in the United States
                is around $15.6 billion per year. These figures are based on
                data collected by the CDC and other federal agencies, as well as
                research studies. A portion of this would be from spoiled food.
                <br />
                <br />
